      ...
      <div className="max-w-6xl w-full mx-auto flex flex-col items-center">
        ...
        >
          {whydata.map((data, index) => (
            <div
              key={index}
              className="flex flex-col bg-[#E8F7E3] rounded-2xl p-4 sm:p-5 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 border border-gray-100"
            >
              {/* Image */}
              <div className="w-full h-40 sm:h-44 md:h-48 rounded-xl overflow-hidden mb-4">
                <img
                  src={data.img}
                  alt={data.title}
